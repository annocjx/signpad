...
import org.swan.sign.views.SignaturePad;
 ...
 public void askForPermissions() {
    ...
    */
    ...
    public File getAlbumStorageDir(String albumName) {
        ...
        file = new File("/sdcard/mapsoft/",albumName);///sdcard/mapsoft
       // file = new File(Environment.getExternalStorageDirectory().getPath(),albumName);
        if (!file.mkdirs()) {
            Log.e("SignaturePad", "Directory not created:"+file.getAbsolutePath());
        }
        return file;
    }
